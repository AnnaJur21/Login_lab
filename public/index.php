...
<body>
    ...
    <div class="container">
      <div class="header clearfix">
        ...
        <h3 class="text-muted"> Login exercise - Home page</h3>
      </div>

        <div class="mainarea">
            <h1>Status: Congratulation, You are logged in <?php echo $_SESSION['Username'];?> </h1>
            <p class="lead">Press below button to logout! We will miss you!</p>
